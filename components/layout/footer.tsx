      ...
      <div className="bg-secondary-800 py-4">
        <Container size="xl">
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
            <span className="text-sm text-secondary-400">Quick Links:</span>
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-block mb-4">
                <div className="flex flex-col">
                  <span className="text-2xl font-bold text-white">JDSS & Co</span>
                  <span className="text-sm text-secondary-400">Chartered Accountants</span>
                </div>
              </Link>
              ...
              <div className="flex gap-4 mt-6">
                {companyInfo.socialLinks.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-secondary-800 flex items-center justify-center text-secondary-400 hover:bg-primary-700 hover:text-white transition-colors"
                    aria-label="LinkedIn"
                  >
