  ...
  return (
    <section className="section-padding bg-primary-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-accent-teal rounded-full filter blur-3xl -translate-x-1/2 translate-y-1/2" />
      </div>
      ...
      <Container size="xl" className="relative">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">The JDSS Advantage</h2>
