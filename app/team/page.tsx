...
const teamMembers = [
  {
    ...
    name: 'S Sivakumar',
    role: 'Partner',
    designation: 'FCA, MBA, Registered Valuer (IBBI), Independent Director',
    ...
    qualifications: ['Fellow Chartered Accountant', 'MBA', 'Registered Valuer (IBBI)', 'Independent Director'],
  ...
  },
  {
    ...
    qualifications: ['Fellow Chartered Accountant', 'CISA (ISACA USA)', 'Forensic Accounting & Fraud Detection (FAFD)'],
